...
public class SystemLogAspect {
    ...
    //Service层切点
    @Pointcut("@annotation(com.flybeifeng.annotation.SystemServiceLog)")
    public void serviceAspect() {
    }

    //Controller层切点
    @Pointcut("@annotation(com.flybeifeng.annotation.SystemControllerLog)")
